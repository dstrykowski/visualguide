...
The composers represented here worked most often with publishers who were based in the same country, especially with regard to the publication of first editions (as shown here). Nevertheless, some published first editions aboard. Beethoven, for example, saw a significant number of works first printed in London. Towards the end of the nineteenth century, a few composers (such as Antonín Dvořák) even began to sell their music to American publishers in New York City.
