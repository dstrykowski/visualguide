...
These numbers display a rough correlation to the total number of works that each composer published (above). For example, Ludwig van Beethoven worked with the greatest number of publishers and also published the most music. But the composer who worked with the fewest publishers was Johannes Brahms, who nevertheless published more music than several of the others.
